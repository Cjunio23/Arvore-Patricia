...
import Itens.ExtraiPalavra;
import Itens.ItemPatricia;
        ...
        private void pesquisa(String k, PatNo t, ExtraiPalavra ep) {
            ...
            if (this.eExterno(t)) {
                ...
                if (aux.chave_str.equals(k_convertido)) {
                    System.out.println("\n Elemento '" + aux.ip.getChave()
                            + "encontrado" );

                    System.out.println( "Este elemento tem ocorrencia nas posicao(oes): " + aux.ip.getListaOcorrencia() + "\n");
                } else {
